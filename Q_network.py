...
# output of first conv will be (W - F + 2P)/S + 1 = (16,12,32)
model.add(Convolution2D(32, 8, 8, subsample=(4, 4), input_shape=(68, 52, 4), activation='relu'))
# second conv has 64 4*4 filters, stride 2, producing an activation volume of shape (7, 5, 64)
model.add(Convolution2D(64, 4, 4, subsample=(2, 2), activation='relu'))
# third conv has 64 3*3 filters, stride 1, producing a volume of shape (5, 3, 64)
